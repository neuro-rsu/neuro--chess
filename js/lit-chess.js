import { ChessElement, html, css } from './chess-element.js'
...
class LitChess extends ChessElement {
    ...
    render() {
        return html`
            ...
            <header>
                <chess-button name='remove' border='none' size=28 @click=${() => --this.row}></chess-button>
                <div class='txt'>${this.row}</div>
                <chess-button name='add' border='none' size=28  @click=${() => ++this.row}></chess-button>
                <chess-button name='remove' border='none' size=28 @click=${() => --this.column} style='margin-left: 4px'></chess-button>
                <div class='txt'>${this.column}</div>
                <chess-button name='add' border='none' size=28  @click=${() => ++this.column}></chess-button>
